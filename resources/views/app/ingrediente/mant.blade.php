...
{!! Form::model($ingrediente, $formData) !!}
	...
	<div class="form-group">
		...
		<div class="col-lg-9 col-md-9 col-sm-9">
			{!! Form::text('nombre1', $ingrediente===NULL?"":$ingrediente->nombre, array('class' => 'form-control', 'id' => 'nombre1', 'placeholder' => 'Ingrese nombre', 'maxlength' => '100')) !!}
		</div>
	</div>
	<div class="form-group">
